...
/**
 * 
 * Die Klasse KlinikMenue enthält die main Methode bzw. den Startpunkt unseres
 * Programms und somit dient sie als Testdriver Klasse. Sie stellt das
 * Programmoberfläche dar. Außerdem enthält diese Klasse Methoden zum Zeigen
...
public class KlinikMenue {
	 ...
	 * @throws Throwable fängt sowohl checkedExceptions als auch uncheckedExceptions
	 */
	...
	/**
	 * Stellt die Oberfläche unseres Programms dar und gibt die Wahl des Benutzers
	 * zurück.
	 * 
	 * @param scanner dient zum Eingeben vom Daten durch den Benutzer.
	 * @return die Operation, die der Benutzer gewählt hat
	 * @throws Throwable fängt sowohl checkedExceptions als auch uncheckedExceptions
	 */
	...
	/**
	 * Stellt die Oberfläche unseres Programms dar und trägt die Daten eines
	 * Patienten ein.
	 * 
	 * @param scanner dient zum Eingeben vom Daten durch den Benutzer.
	 */
